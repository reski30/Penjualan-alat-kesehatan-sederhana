...
<div class="form-group">
 ...
 <div class="form-group">
    <select class="form-control" id="warnabaju" name="warnabaju">
      <option>Pilih Warna Baju---</option>
		  	<option value="Hijau Putih">Hijau Putih</option>
		  	<option value="Kuning">Kuning</option>
		  	<option value="Biru Oren">Biru Oren</option>
...
$(document).ready(function(){
    $('#kota').change(function() {
        ...
        if (kota == 'pekanbaru') {
            ...
            $('#apotik').append(`<option value="Kimia Farma">Kimia Farma</option>`);
...
<div style="width: 50%; margin-left: 500px;">
	<a href="laporan2.php" class="btn btn-primary btn-lg">Lihat Laporan per Distributor</a>
	<br>
	<br>
	<br>
</div>
